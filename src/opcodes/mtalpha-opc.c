...
/*** MT extensions ***/
  ...
  { "ldbp",       OPRL(0x01,0x00), BASE, { ZA, ZB,  RC } },
  { "ldfp",       OPRL(0x01,0x01), BASE, { ZA, ZB,  RC } },
  { "gettid",     OPRL(0x01,0x02), BASE, { ZA, ZB,  RC } },
  { "getfid",     OPRL(0x01,0x03), BASE, { ZA, ZB,  RC } },
  { "getpid",     OPRL(0x01,0x04), BASE, { ZA, ZB,  RC } },
  { "getcid",     OPRL(0x01,0x05), BASE, { ZA, ZB,  RC } },
  { "getasr",     OPRL(0x01,0x06), BASE, { ZA, LIT, RC } },
  { "getapr",     OPRL(0x01,0x07), BASE, { ZA, LIT, RC } },
  ...
  { "setlimit",   OPRL(0x01,0x21), BASE, { RA, LIT, ZC } },
  { "setstep",    OPR (0x01,0x22), BASE, { RA, RB,  ZC } },
  ...
  { "creba/s",    OPR (0x01,0x61), BASE, { RA, RB,  RC } },
  { "creba/s",    OPRL(0x01,0x61), BASE, { RA, LIT, RC } },
  { "crebi/a",    OPR (0x01,0x71), BASE, { RA, RB,  ZC } },
  { "crebi/a",    OPRL(0x01,0x71), BASE, { RA, LIT, ZC } },
  { "crebi/s",    OPR (0x01,0x71), BASE, { RA, RB,  RC } },
  { "crebi/s",    OPRL(0x01,0x71), BASE, { RA, LIT, RC } },
